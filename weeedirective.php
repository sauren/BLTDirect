        ...
        <div id="PageWrapper">
            <div id="Page">
                <div id="PageContent">
					...
					<h1>WEEE Directive</h1>
					<strong>Helping to recycle your electrical equipment</strong>
					...
					<div class="TextColumns">
						<div class="TextColumn2">
							...
							<p>Those establishing their own take-back scheme must as a minimum offer all customers buying new electrical equipment free take back of their old electricals on a like-for-like basis.</p>

							<p>To remind you that old electrical equipment can be recycled, it is now marked with a crossed-out wheeled bin symbol.</p>

							<p>Please do not throw any electrical equipment (including those marked with the crossed out wheeled bin symbol) in your bin.</p>


							<h3>Why Recycle?</h3>

							<p>Unwanted electrical equipment is the UKs fastest growing type of waste. Many electrical items can be repaired or recycled, saving natural resources and the environment. If you do not recycle, electrical equipment will end up in landfill where hazardous substances will leak out and cause soil and water contamination – harming wildlife and also human health.</p>


							<h3>We can help</h3>

							<p>If you’re buying a new electrical item, we will recycle your old one for free, please contact us for further details on how to return an item.</p>
						</div>
						<div class="TextColumnDivider">&nbsp;</div>
						<div class="TextColumn2">
							<h3>Waste Battery Regulations</h3>

							<p>Ellwood Electrical Limited incorporating BLTDirect are now offering a take back scheme for all portable waste batteries.</p>

							<p>You can return your waste batteries to our business premises in person (PLEASE DO NOT POST).</p>

							<p>Alternatively, you can find your local waste portable battery recycling facility at <a href="http://www.recyclenow.com" target="_blank">www.recyclenow.com</a></p>

							<p>Most supermarkets and shops that sell batteries will have collection bins for used batteries, and some town halls, libraries or schools may also set up collection points. End-users may find stores in their local area more accessible.</p>
						</div>
					</div>
					<div class="clear"></div>
