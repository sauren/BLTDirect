...
function view($supplierId) {
	...
	$table->SetSQL(sprintf("SELECT srr.*, DATE(srr.CreatedOn) AS CreatedDate FROM supplier_return_request AS srr WHERE srr.Status LIKE 'Confirmed' AND srr.SupplierID=%d", $supplierId));
