...
function view() {
	$page = new Page('New Orders', 'Listing all new and unread orders.');
	$page->Display('header');

	$table = new DataTable('orders');
	$table->SetSQL("SELECT o.*, pg.Postage_Title, pg.Postage_Days FROM orders AS o LEFT JOIN postage AS pg ON o.Postage_ID=pg.Postage_ID WHERE o.Status LIKE 'Unread' AND o.Is_Awaiting_Customer='N'");
