    ...
    <td valign="top"><p><strong><?php echo $product->Name; ?></strong><br /><?php if(isset($breadCrumb)) echo $breadCrumb->Text; ?></p>
			...
			<table border="0" width="100%" cellspacing="0">
				<tr>
					...
					<?php
					if(!empty($product->DefaultImage->Large->FileName)){
				...
				<?php
			      ...
			      <td valign="top"><p>
						...
						<p>
						<?php echo $product->GetBuyIt($category->ID, false, 'purchase_customise.php'); ?>
						<br />
					  </p>
					  <p>
			  ...
			  <?php
				...
				// Get Components
				$components = new DataQuery("select * from product_components where Is_Active='Y' and Component_Of_Product_ID=" . $product->ID);
			...
			?>
				<tr>
					...
					<td><a href="product.php?pid=<?php echo $component->ID; ?>"><strong><?php echo $component->Name; ?></strong><br /><?php echo $component->Blurb; ?></a></td>
			...
			?>
				<tr>
					<td><a href="./product.php?pid=<?php echo $prod->ID; ?>&cat=<?php echo $category->ID; ?>"><img src="./images/products/<?php echo $prod->DefaultImage->Thumb->FileName; ?>" border="0" width="<?php echo $prod->DefaultImage->Thumb->Width; ?>" height="<?php echo $prod->DefaultImage->Thumb->Height; ?>" alt="Click to View Product Information" /></a></td>
					<td>
						<a href="./product.php?pid=<?php echo $prod->ID; ?>&cat=<?php echo $category->ID; ?>" title="Click for More Information"><strong><?php echo $prod->Name; ?></strong><br />
