...
//******************************************************************************
    ...
    var scwDropDownYears = scwDateNow.getFullYear()+10 - scwBaseYear;
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #aaaaaa;}'  +
            '/* Drag Handle */'                                         +
            ...
            'td.scwInputDate            {background-color:  #6666cc;'   +
                                        'color:             #ffffff;}'  +
            '/* Weekend Day */'                                         +
...
// ***************************
    ...
    document.write(
     ...
     "<![endif]-->" +
     "<!--[if lt IE 7]>" +
        "<iframe class='scw' src='blank.html' " +
