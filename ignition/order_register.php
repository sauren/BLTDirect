...
$form->AddField('businesscountry', 'Country', 'select', $address->Country->ID, 'numeric_unsigned', 1, 11, ($isBusiness)?true:false, 'onChange="propogateRegions(\'businessregion\', this);"');
...
$form->AddField('accountsname', 'Name', 'text', '', 'name', 1, 60, ($isBusiness && $isAsAccount)?true:false, ($form->GetValue('accountsinvoice') == 'N') ? 'disabled="disabled"' : '');
$form->AddField('accountspostcode', 'Postcode', 'text', '', 'postcode', 1, 10, false, ($form->GetValue('accountsinvoice') == 'N') ? 'disabled="disabled"' : '');
$form->AddField('accountsaddress1', 'Property Name/Number', 'text', '', 'address', 1, 150, ($isBusiness && $isAsAccount)?true:false, ($form->GetValue('accountsinvoice') == 'N') ? 'disabled="disabled"' : '');
$form->AddField('accountsaddress2', 'Street', 'text', '', 'address', 1, 150, ($isBusiness && $isAsAccount)?true:false, ($form->GetValue('accountsinvoice') == 'N') ? 'disabled="disabled"' : '');
$form->AddField('accountsaddress3', 'Area', 'text', '', 'address', 1, 150, false, ($form->GetValue('accountsinvoice') == 'N') ? 'disabled="disabled"' : '');
$form->AddField('accountscity', 'City', 'text', '', 'address', 1, 150, ($isBusiness && $isAsAccount)?true:false, ($form->GetValue('accountsinvoice') == 'N') ? 'disabled="disabled"' : '');
$form->AddField('accountscountry', 'Country', 'select', $GLOBALS['SYSTEM_COUNTRY'], 'numeric_unsigned', 1, 11, ($isBusiness && $isAsAccount)?true:false, 'onchange="propogateRegions(\'accountsregion\', this);"' . (($form->GetValue('accountsinvoice') == 'N') ? ' disabled="disabled"' : ''));
...
$form->AddField('reg', 'Company Registration', 'text', '', 'address', 1, 50, false);
