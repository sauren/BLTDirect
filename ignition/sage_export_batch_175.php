...
function locked() {
	$page = new Page(sprintf('<a href="%s">Sage Export Batch (UK Only)</a> &gt; Integration Locked', $_SERVER['PHP_SELF']), 'Sage integration locked.');
	$page->Display('header');
...
function complete() {
	$page = new Page(sprintf('<a href="%s">Sage Export Batch (UK Only)</a> &gt; Integration Complete', $_SERVER['PHP_SELF']), 'Sage integration complete.');
...
function integrate() {
	...
	$page = new Page('Sage Export Batch (UK Only) (Pre VAT Rise)', 'Integrate with Sage.');
