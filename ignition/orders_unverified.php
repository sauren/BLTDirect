...
function view() {
	$page = new Page('Unverified Orders', 'Listing all payment unverified orders.');
	$page->Display('header');
	
	$table = new DataTable('orders');
	$table->SetSQL("SELECT o.*, pg.Postage_Title, pg.Postage_Days FROM orders AS o LEFT JOIN postage AS pg ON o.Postage_ID=pg.Postage_ID WHERE (o.Status LIKE 'Unread' OR o.Status LIKE 'Pending' OR o.Status LIKE 'Packing' OR o.Status LIKE 'Partially Despatched') AND o.Is_Payment_Unverified='Y' AND o.Is_Awaiting_Customer='N'");
