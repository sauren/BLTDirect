...
function view($supplierId) {
	$page = new Page('Warehouse Declined Orders', 'Listing all warehouse declined orders.');
	$page->Display('header');
	?>
