...
function start() {
	...
	$page = new Page('Orders Broken Upon Delivery Report');
	...
	$window = new StandardWindow("Report on orders broken upon delivery.");
...
function report() {
			...
			if($data->TotalRows > 0) {
                ...
                while($data->Row) {
                    ...
                    foreach($products as $product) {
						...
						$line->Reason = 'Broken during transit.';
	...
	$page = new Page('Orders Broken Upon Delivery Report: ' . cDatetime($date, 'longdate'));
	$page->Display('header');
