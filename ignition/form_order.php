...
function start(){
	...
	$window = new StandardWindow("Order form for Products from a Category.");
...
function report($cat, $sub) {
	...
	$data = new DataQuery(sprintf("SELECT ws.*, p.Product_Title, p.SKU,
							...
							INNER JOIN product_in_categories AS cat ON p.Product_ID=cat.Product_ID
	...
	<table align="center" cellpadding="4" cellspacing="0" class="DataTable">
		  ...
		  <tr>
			...
			<th nowrap align="right"><strong>Order Qty</strong></td>
		  </tr>
		  </thead>
		  <tbody>
		  <?php
