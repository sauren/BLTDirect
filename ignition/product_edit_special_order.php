...
$form->AddField('supplier', 'Supplier', 'select', $product->SpecialOrderSupplierID, 'numeric_unsigned', 1, 11);
...
$form->AddField('leaddays', 'Lead Days', 'text', $product->SpecialOrderLeadDays, 'numeric_unsigned', 1, 11);

if(isset($_REQUEST['confirm'])) {
	if($form->Validate()){
		$product->SpecialOrderSupplierID = $form->GetValue('supplier');
		$product->SpecialOrderLeadDays = $form->GetValue('leaddays');
		$product->Update();
