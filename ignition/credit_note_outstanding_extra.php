...
function view() {
	...
	$page = new Page('Pending Credit Notes (Non UK or Non VAT)', 'Below is a list of all account credit notes missing transaction references.');
	$page->Display('header');
			...
			if($data->TotalRows > 0) {
				while ($data->Row) {
					...
					<tr class="dataRow" onMouseOver="setClassName(this, 'dataRowOver');" onMouseOut="setClassName(this, 'dataRow');">
						<td class="dataOrdered" align="left"><?php echo $data->Row['Credited_On']; ?></td>
