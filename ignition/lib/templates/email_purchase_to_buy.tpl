<p>Please accept this as a purchase order</p>
<table border="0" width="100%" cellspacing="0">
	<tr>
	  <td width="50%">
		...
		<td align="right"><p>Ellwood Electrical Ltd.<br>
	    ...
	    <p>VAT No. 637 0697 18</p></td>
			...
			<table width="100%" cellspacing="0" cellpadding="5" class="order">
				<tr>
					...
					<th align="left" style="border-bottom:1px solid #FA8F00;">Cost Per Item</th>
