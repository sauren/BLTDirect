...
-->
</style><title>Customer Invoice</title></head>
<body>
<p>&nbsp;</p>
	...
	<tr>
	  <td width="50%">
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="border:1px solid #aaaaaa;" width="100%">
          <tr>
            <td valign="top" style="padding:10px;" width="50%"><p><strong>Invoice Address:</strong><br />[BILLTO]</p></td>
          </tr>
        </table>
        <br>
		<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#eeeeee" style="border:1px solid #aaaaaa;">
              <tr>
                <td valign="top" style="padding:10px;" width="25%"><strong>Invoice No: </strong><br>[INVOICE_REF]&nbsp;</td>
                <td valign="top" style="padding:10px;" width="25%"><strong>Invoice Date: </strong><br>[INVOICE_DATE]&nbsp;</td>
              </tr>
			  <tr>
                <td valign="top" style="padding:10px;" width="25%"><strong>Order No: </strong><br>[ORDER_REF]&nbsp;</td>
                <td valign="top" style="padding:10px;" width="25%"><strong>Invoice Due: </strong><br>[INVOICE_DUE]&nbsp;</td>
              </tr>
              <tr>
                <td valign="top" style="padding:10px;" width="25%"><strong>Your Ref No: </strong><br>[CUSTOM_REF]&nbsp;</td>
                <td valign="top" style="padding:10px;" width="25%"><strong>VAT Info (No): </strong><br>[TAX_CODE]&nbsp;</td>
              </tr>
            </table>
	    </td>
	    ...
	    <p>VAT No. 637 0697 18</p></td>
			...
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td align="left" valign="top" width="49%">
						...
						<table width="100%" border="0" cellpadding="5" cellspacing="0" class="order">
		                    <tr>
								<th colspan="2" align="left" style="border-bottom: 1px solid #FA8F00;">Direct Payment - Please note our new bank details</th>
							</tr>
							<tr>
								<td>Bank:</td>
								<td align="right">Lloyds TSB</td>
							</tr>
							<tr>
								<td>Sort Code:</td>
								<td align="right">30-94-55</td>
							</tr>
							<tr>
								<td>Account Number:</td>
								<td align="right">2931304</td>
							</tr>
							<tr>
								<td>Account Name:</td>
								<td align="right">Ellwood Electrical Ltd. Incorporating BLT Direct</td>
							</tr>
						</table>
				...
				<table width="100%" border="0" cellpadding="5" cellspacing="0" class="order">
                    ...
                    <tr>
                      <td>Card Number</td>
                      <td align="right">[CARD_NUMBER]</td>
                    </tr>
                                    </table></td>
		        </tr>
</table>
            <br>
            <table cellpadding="0" cellspacing="0" border="0" style="border:1px solid #aaaaaa;" width="50%">
	          <tr>
	            <td valign="top" style="padding:10px;" width="50%"><p><strong>Shipping Address:</strong><br />[SHIPTO]</p></td>
	          </tr>
	        </table>
	        <br>
