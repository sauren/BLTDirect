	...
	<tr>
	  <td width="50%">
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="border:1px solid #aaaaaa;" width="100%">
          <tr>
            <td valign="top" style="padding:10px;" width="50%"><p> <strong>Billing Address:</strong><br />
        [BILLTO]</p></td>
          </tr>
        </table>
        <br>
		<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#eeeeee" style="border:1px solid #aaaaaa;">
              <tr>
                <td valign="top" style="padding:10px;" width="25%"><p> <strong>Credit #: </strong><br>
                  [CREDIT_REF]</p></td>
                <td valign="top" style="padding:10px;" width="25%"><strong>Issue Date: </strong><br>
                [ISSUE_DATE]</td>
              </tr>
			  <tr>
                <td valign="top" style="padding:10px;" width="25%"><p> <strong>Order #: </strong><br>
                  [ORDER_REF]<br>
                  <br>
                </p></td>
                <td valign="top" style="padding:10px;" width="25%"><strong>Your Ref#: </strong><br>
[CUSTOM_REF]</td>
              </tr>
            </table>
      </td>
	    ...
	    <p>VAT No. 637 0697 18</p></td>
			...
			<table width="100%" cellspacing="0" cellpadding="5" class="order">
				<tr>
					...
					<th align="left" style="border-bottom:1px solid #FA8F00;">Price</th>
					<th align="left" style="border-bottom:1px solid #FA8F00;">Line Total</th>
				</tr>
							[LINES]
							[CUSTOM]
							<tr>
			...
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
				  <td align="right" valign="top"><table border="0" cellpadding="5" cellspacing="0" class="order">
                    <tr>
                      <th colspan="2" align="left" style="border-bottom:1px solid #FA8F00;">Tax &amp; Shipping Refund </th>
                    </tr>
                    <tr>
                      <td>Shipping:</td>
