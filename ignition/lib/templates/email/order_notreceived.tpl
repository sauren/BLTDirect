<p>Please reply to this email confirming the below products and quantities that you have not received.</p>
<p>Please confirm full delivery details in order for us to check our records and any restrictions on delivery (i.e. opening or closing hours) or special requirements and drop off points.</p>
			...
			<table cellpadding="0" cellspacing="0" border="0" style="border:1px solid #aaaaaa;">
				<tr>
					<td valign="top" style="padding:10px;" width="50%">
						<p><strong>Billing Address:</strong><br />[BILLTO]</p>
					</td>
					<td valign="top" style="padding:10px; background-color:#eeeeee;">
						<p><strong>Shipping Address:</strong><br />[SHIPTO]</p>
					</td>
				</tr>
			</table>
		...
		<td width="50%" align="right" valign="top">
			...
			<table cellpadding="3" cellspacing="0" border="0" style="border:1px solid #aaaaaa;">
				<tr>
					...
					<td nowrap="nowrap" valign="top" style="padding: 5px;">[ORDER_REF]</td>
				</tr>
				<tr>
