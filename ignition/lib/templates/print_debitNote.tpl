...
-->
</style><title>Debit Note</title></head>
<body>
<p>&nbsp;</p>
	  ...
	  <td width="50%">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#eeeeee" style="border:1px solid #aaaaaa;">
              <tr>
                ...
                <td valign="top" style="padding:10px;" width="25%"><p> <strong>Debit Note #: </strong><br>
                  [DEBIT_REF]<br>
                  </p></td>
                <td valign="top" style="padding:10px;" width="25%"><strong>Debit Note Date: </strong><br>
                [DEBIT_DATE]</td>
              </tr>
...
Email sales@bltdirect.com</p>
			...
			<table width="100%" cellspacing="0" cellpadding="5" class="order">
				<tr>
					...
					<th align="right" style="border-bottom:1px solid #FA8F00;">Cost</th>
					<th align="right" style="border-bottom:1px solid #FA8F00;">Line Cost</th>
            ...
            <table border="0" width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td align="right" valign="top"><table border="0" cellpadding="5" cellspacing="0" class="order">
                    <tr>
                      <th colspan="2" align="left" style="border-bottom:1px solid #FA8F00;">Tax</th></tr>
                    <tr>
                      <td>Sub Total:</td>
...
<p style="text-decoration: underline; text-align: center; font-size: 12px; font-weight: bold; color: #FA8F00;">A credit note is not required in response to this debit note and any queries must be directed immediately to the purchasing manager of BLT Direct.</p>
