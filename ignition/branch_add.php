...
$form->AddField('name','Branch Name','text','','anything',1,60);
$form->AddField('hq','Is this branch your Head Quarters?','select','N','alpha',0,4);
$form->AddOption('hq','N','No');
$form->AddOption('hq','Y','Yes');
//Address information
$form->AddField('address1', 'Property Name/Number', 'text', '', 'address', 1, 150, false);
...
$region->Disconnect();
unset($region);
$form->AddField('postcode', 'Postcode', 'text', '', 'anything', 1, 10,false);

$form->AddField('phone1','Phone 1','text','','anything',1,15,false);
$form->AddField('phone1ext','Phone 1 Ext','text','','anything',1,5,false);
$form->AddField('phone2','Phone 2','text','','anything',1,15,false);
$form->AddField('phone2ext','Phone 2 Ext','text','','anything',1,5,false);
$form->AddField('fax','fax','text','','anything',1,15,false);
$form->AddField('email','Email','text','','email',NULL,NULL);
$form->AddField('company','Company Number','text','','anything',1,100,false);
$form->AddField('tax','Tax Number','text','','anything',1,100,false);


$form->AddField('orgType', 'Organisation Type', 'select', '0', 'numeric_unsigned', 1, 11,false);
...
$form->AddField('public','Can Public Contact','select','N','alpha',0,4);
$form->AddOption('public','N','No');
$form->AddOption('public','Y','Yes');

$form->AddField('support','Is this branch a customer service and support branch?','select','N','alpha',0,4);
$form->AddOption('support','N','No');
$form->AddOption('support','Y','Yes');


$form->AddField('sales','Is this branch a sales branch','select','N','alpha',0,4);
...
echo $webForm->AddRow("&nbsp;", sprintf('<input type="button" name="back" value="back" class="btn" onClick="window.self.location=\'branch_view.php\';"> <input type="submit" name="add" value="add" class="btn" tabindex="%s">', $form->GetTabIndex()));
echo $webForm->Close();
echo $window->CloseContent();
echo $window->Close();
echo $form->Close();
