...
function start(){
	...
	$page = new Page('Schedule Breakdown Report', 'Please choose a start and end date for your report');
...
function report($start, $end){
				...
				if($data->TotalRows > 0) {
					while($data->Row) {
						...
						<tr class="dataRow" onMouseOver="setClassName(this, 'dataRowOver');" onMouseOut="setClassName(this, 'dataRow');">
							<td><?php echo cDatetime($data->Row['Completed_On'], 'shortdatetime'); ?></td>
							...
							<td><?php echo nl2br($data->Row['Message']); ?></td>
						</tr>
	...
	<input type="button" class="btn" name="print" value="print" onclick="window.print();" />
