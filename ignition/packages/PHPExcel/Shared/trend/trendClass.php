...
include_once('Shared/trend/linearBestFitClass.php');
include_once('Shared/trend/logarithmicBestFitClass.php');
include_once('Shared/trend/exponentialBestFitClass.php');
include_once('Shared/trend/powerBestFitClass.php');
include_once('Shared/trend/polynomialBestFitClass.php');
