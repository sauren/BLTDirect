...
require_once 'Calculation/FormulaParser.php';

/** PHPExcel_Calculation_FormulaToken */
require_once 'Calculation/FormulaToken.php';

/** PHPExcel_Calculation_Functions */
require_once 'Calculation/Functions.php';

/** PHPExcel_Calculation_Function */
require_once 'Calculation/Function.php';

/** PHPExcel_Calculation_ExceptionHandler */
require_once 'Calculation/ExceptionHandler.php';
