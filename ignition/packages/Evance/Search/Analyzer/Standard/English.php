...
require_once 'Evance/Search/Analyzer/Standard.php';
require_once 'Evance/Search/TokenFilter/EnglishStemmer.php';
...
class Evance_Search_Analyzer_Standard_English extends Evance_Search_Analyzer_Standard
{
    ...
    public function __construct()
    {
        ...
        $this->addFilter(new Evance_Search_TokenFilter_EnglishStemmer());	
    }
}
