...
<head>
	...
	<title>BLT Direct - Online Brochures</title>
	<!-- InstanceEndEditable -->
        ...
        <div id="PageWrapper">
            <div id="Page">
                <div id="PageContent">
					...
					<h1>Online Brochures</h1>
					<p>View the contents of our PDF brochures here in HTML format.</p>

					<h3><a href="/brochures/spring2009.php" title="BLT Direct Spring 2009 Brochure">Spring 2009</a></h3>
					<p>Do your bit for the environment. Energy Saving Mini Pleq Lamp from &pound;1.99</p>
