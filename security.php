...
<head>
	...
	<title>BLT Direct Security</title>
	<!-- InstanceEndEditable -->
    ...
    <div id="Wrapper">
        ...
        <div id="PageWrapper">
            <div id="Page">
              ...
              <h1>Security at BLT</h1>
			  <p>At BLT we take your securtiy seriously. Our site checkout process and our customer account centre is protected by 128-bit SSL encryption. Look for the padlock in your web browser (pictured below).</p>

				<table width="100%">
					<tr>
						<td width="50%" align="center"><img src="images/security_1.gif" width="153" height="69" alt="IE 5/6" /><br /><br /><em><strong>IE 5/6</strong><br />Padlock at bottom of window</em></td>
						<td width="50%" align="center"><img src="images/security_2.gif" width="155" height="69" alt="IE 7" /><br /><br /><em><strong>IE 7</strong><br />Padlock at top of window</em></td>
					</tr>
				</table><br />
				
			  <p>When purchasing online your credit card details are handled with great care and attention to your security. Any sensitive information is encrypted with powerful industry standard algorithms before they are stored in our database leaving you safe in the knowledge that your details are secure.</p>
			  <h3>Keep Your Computer Secure </h3>
			  <p>It is important that when using technology you keep away from those that may wish to harm or take advantage of you. It doesn't matter how long you think you will be on the internet, any computer that accesses the web is at risk of virus infection, hackers and trojans. We recommend that you keep your computer up-to-date with the latest anti-virus software and firewall protection. You should also remember to update your PC with the latest patches available from your operating system manufacturer. </p>
			  <h3>Why is keeping your computer secure so important?</h3>
			  <p>Any system is only as secure as its weakest link. Although we take care that our website is secure with the latest  technology your Credit Card details, and your computer itself, could still be at risk if you do not maintain your computer as recommended above.</p>
			<!-- InstanceEndEditable -->
                </div>
            </div>
            <div id="PageFooter">
