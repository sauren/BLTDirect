...
function view() {
	...
	if($data->Row['Count'] > 0) {
		$bubble = new Bubble('Incomplete Schedules', 'You must complete any outstanding scheduled health &amp; safety tasks before access to the remainder of this control panel is restored for your user account.');
