...
<table width="100%" border="0">
  <tr>
	...
	$prompt->Output('ordercreate');
	
	echo $prompt->Body;
	?>
	
    <p><strong>Before beginning a new order please check that the shopping cart to the left is empty. If items already exsit in your cart please click on the clear shopping cart in the toolbox.</strong></p>
