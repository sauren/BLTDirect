...
<head>
	...
	<title>Potential Security Breach</title>
	<!-- InstanceEndEditable -->
        ...
        <div id="PageWrapper">
            <div id="Page">
                <div id="PageContent">
					...
					<h1>Potential Security Breach</h1>
					<p>An anomaly has been detected with your current session and has been permanently disabled. If you were logged in, you have been automatically logged out to prevent any unauthorized access to you account details and you will be required to re-submit your account credentials before accessing secured areas of our site.</p>
					<p>Possible reasons for this security breach may include:</p>
					<ul>
						<li>If you are using a proxy whose client attributes continually fluctuate between page requests.</li>
						<li>If the IP address logged against your session data changes unexpectedly.</li>
						<li>If another party attempts to hijack your session and gain access to your account.</li>
					</ul>
					<p>In the event that you experience this incident repeatedly please contact us on <strong><?php echo $GLOBALS['COMPANY_PHONE']; ?></strong> so that we may investigate the nature of the potential security breaches.</p>
					<!-- InstanceEndEditable -->
                </div>
            </div>
            <div id="PageFooter">
