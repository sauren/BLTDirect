					...
					<div class="product-image">
						<div class="product-image-main">
							...
							if(!empty($product->DefaultImage->Large->FileName) && file_exists($GLOBALS['PRODUCT_IMAGES_DIR_FS'].$product->DefaultImage->Large->FileName)) {
								...
								<img id="product-image-main" src="<?php echo $GLOBALS['PRODUCT_IMAGES_DIR_WS'].$product->DefaultImage->Large->FileName; ?>" alt="<?php echo $product->Name; ?>" align="middle" />
...
-->							<div class="tab-content-side">
						...
						if(count($product->Spec) > 0) {
							?>
						<div id="menubodytitles" onclick="setContent('specifications');"><div id="menutitles"><a class="WhiteLnkSideMenu" title="Specification"><center>Specification</center></a></div></div>
...
-->							
						...
						if(count($product->RelatedType[''])>0) {
							?>
  						<div id="menubodytitles" onclick="setContent('related');"><div id="menutitles"><a class="WhiteLnkSideMenu" title="Related"><center>Related</center></a></div></div>
...
-->							<div class="tab-content-title">
						...
						if(count($product->RelatedType['Energy Saving Alternative'])) {
							?>
                          		<div id="menubodytitles" onclick="setContent('relatedenergysaving');"><div id="menutitles"><a class="WhiteLnkSideMenu" title="Related Energy Saving"><center>Related Energy Saving</center></a></div></div>
...
-->
						...
						if(count($product->Component)>0) {
							?>
                          		<div id="menubodytitles" onclick="setContent('components');"><div id="menutitles"><a class="WhiteLnkSideMenu" title="Components"><center>Components</center></a></div></div>
...
-->								<div class="tab-content-title">
						...
						?>
                          		...
                          		<div id="menubodytitles" onclick="setContent('reviews');"><div id="menutitles"><a class="WhiteLnkSideMenu" title="Reviews"><center>Reviews</center></a></div></div>
...
-->												<input type="button" name="create" value="Create Review" class="button" onclick="showReview();" />
							...
							<div class="clear"></div>
                          		...
                          		<div id="menubodytitles" onclick="setContent('enquire');"><div id="menutitles"><a class="WhiteLnkSideMenu" title="Enquiry"><center>Enquiry</center></a></div></div>
