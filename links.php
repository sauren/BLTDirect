...
<head>
	...
	<title>BLT Direct - Useful Links</title>
<!-- InstanceEndEditable -->
    ...
    <div id="Wrapper">
        ...
        <div id="PageWrapper">
            <div id="Page">
              ...
              <h1>Useful Links</h1>
              <p>Ellwood Electrical Ltd are pleased to offer the following useful links. The following links will open in a new web browser window. </p>
              <?php
						...
						while($data->Row) {
							...
							<tr>
			                  ...
			                  if((strlen($data->Row['Image']) > 0) && (file_exists('images/links/'.$data->Row['Image']))) {
				                  ?>
				                  <a href="<?php print $data->Row['URL']; ?>" target="_blank"><img src="images/links/<?php print $data->Row['Image']; ?>" alt="<?php print $data->Row['Title']; ?>" /></a><br />
				                  <?php
			                  }
			                  ?>			                  </td>
