        ...
        <div id="PageWrapper">
			...
			<div class="mainCustomer">
				<div class="orders">
				  ...
				  <p>Bellow is a list of all the orders that you have placed with us which we are very grateful for</p><br />
					...
					<div table-layout:="table-layout:""fixed" class="ordersContainer">
					<table class="summaryTable" cellspacing="0">
						<tbody>
							<tr>
								<td>Today</td>
								<td width="408">Order #100010<br />
