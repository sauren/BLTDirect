        ...
        <div id="PageWrapper">
            <div id="Page">
                <div id="PageContent">
					...
					<p class="blue">Thank you, your friend has been emailed with a link and message.</p>
					<p class="blue"><a href="<?php echo param('page'); ?>">Click here to go back to the page you sent your friend.</a> </p>
					</form>
                    <p>&nbsp;</p>
            <!-- InstanceEndEditable -->
                </div>
