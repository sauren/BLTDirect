...
<!--    <script type='text/javascript' src='http://api.handsetdetection.com/sites/js/43071.js'></script>-->
  ...
  <meta name="Keywords" content="<?php echo $categoryMetaKeywords; ?>" />
  <meta name="Description" content="<?php echo $categoryMetaDescription; ?>" />
  <!-- InstanceEndEditable -->
</head>
<body>
        ...
        <div id="PageWrapper">
            <div id="Page">
			  ...
			  <?php
				...
				while($data->Row) {
					print sprintf('<h2>%s</h2><p><span class="sub-text">%s</span></p><p>%s</p>', $data->Row['Article_Title'], cDatetime($data->Row['Created_On'], 'shortdatetime'), stripslashes($data->Row['Article_Description']));
