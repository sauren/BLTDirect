...
<head>
	...
	<title>Bathroom Zone Guide</title>
<!-- InstanceEndEditable -->
...
<body>
    ...
    <div id="Wrapper">
        ...
        <div id="PageWrapper">
			...
			<h1>Bathroom Zone Guide</h1>

			<p><br /><strong>Lighting Guide</strong><br />The zones indicated on the drawing below give you a guide to what resistance to water your fitting should have if fitted in any of these areas. Lighting is given a rating called an IP rating, which indicates its resistant to water. The higher the rating the more water resistant the fitting.</p>

			<div style="text-align: center" style="padding: 10px;">
				<img src="/images/lightingguide.jpg" alt="Lighting Guide" width="477" height="410" />
			</div>

			<table border="0" cellspacing="5" cellpadding="0" width="100%">
				<tr>
					<td rowspan="2" valign="top" style="width: 33%">
						<p><strong style="color: #f00">Zone 0 - IP 68 (submersible)</strong><br />Inside a bathing area of a bath. Lights are sometimes used to illuminate whirlpool baths and spas.</p>
						<p>All fittings should be 12 volt and there should be a safety source such as a cut-out switch which should be fitted outside these zones.</p>
					</td>
					<td rowspan="2" width="33%" valign="top">
						<p><strong style="color: #f00">Zone 1 - IP 65 (jetproof) down to IP 44 (splashproof)</strong><br />Where there is no shower head or rail over the bath IP 44 (splashproof) should be safe enough, although a fitting should never be touched with wet hands. Inside a shower or bath where there is a shower head or demountable shower handset fittings should be IP 65 (jetproof) or more.</p>
					</td>
					<td width="33%" valign="top">
						<p><strong style="color: #f00">Zone 2 - IP 44 (splashproof)</strong><br />If there is no danger of a direct jetspray being accidently applied to the fitting, IP 44 (splashproof) or greater is required in this area.<br />&nbsp;</p>
					</td>
				</tr>
				<tr>
					<td>
						<p><strong style="color: #f00">Zone 3</strong><br />As long as there is no possibility that any lighting will be splashed with water, or steam will settle on the fitting, IP 44 or IP 65 rated fittings are not needed. </p>
					</td>
				</tr>
			</table>

			<p>NOTE: in areas of high humidity, such as saunas and steam rooms, be safe and stick to at least IP 68 rated fittings.</p>
			<p>THE ABOVE INFORMATION IS INTENDED AS A SIMPLE GUIDE ONLY. BLT Direct takes no responsibility for incorrectly installed luminaires.<br />ANY FINAL DECISIONS ABOUT INSTALLATION SHOULD BE TAKEN BY A QUALIFIED ELECTRICIAN.</p>
