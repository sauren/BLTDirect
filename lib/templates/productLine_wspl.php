...
<tr <?php echo !empty($rowClass) ? sprintf('class="%s"', $rowClass) : ''; ?>>
	<td class="list-image" width="50%" style="border-top: 2px dotted #cdcdcd;">
		<?php
	...
	<td width="50%" style="border-top: 2px dotted #cdcdcd;">
		<div class="product-detail">
			...
			<a href="./product.php?pid=<?php echo $subProduct->ID; ?><?php echo isset($subCategory) ? '&amp;cat=' . $subCategory->ID : ''; ?>" title="<?php echo htmlspecialchars($subProduct->Name); ?>"><?php echo $subProduct->HTMLTitle; ?></a><br />
			<span class="product-detail-ident">QuickFind #: <?php echo $subProduct->PublicID(); ?>, Part Number: <?php echo $subProduct->SKU; ?></span>
