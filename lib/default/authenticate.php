...
<body>
    ...
    <div id="Wrapper">
        ...
        <div id="PageWrapper">
			...
			<iframe src="authverify.php?o=<?php print $_REQUEST['o']; ?>&amp;ASCURL=<?php print urlencode($_REQUEST['ASCURL']); ?>&amp;PaReq=<?php print urlencode($_REQUEST['PaReq']); ?>&amp;MD=<?php print $_REQUEST['MD']; ?>" name="issuer" width="100%" height="500" scrolling="Auto" frameborder="0" id="issuer"></iframe>
