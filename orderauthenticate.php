...
<!--    <script type='text/javascript' src='http://api.handsetdetection.com/sites/js/43071.js'></script>-->
  ...
  <script language="javascript" type="text/javascript">
  function complete() {
  	  	window.self.location.href = 'orders.php?orderid=<?php echo $order->ID; ?>';
  }
  </script>
	<!-- InstanceEndEditable -->
</head>
<body>
    ...
    <div id="Wrapper">
        ...
        <div id="PageWrapper">
			...
			<h1>Authenticate Card Details</h1>
			<p>Please authenticate your card through the issuer 3D-Authentication site.</p>

			<iframe name="issuer" scrolling="auto" frameborder="0" src="orderauthverify.php?orderid=<?php print $_REQUEST['orderid']; ?>&ASCURL=<?php print urlencode($_REQUEST['ASCURL']); ?>&PaReq=<?php print urlencode($_REQUEST['PaReq']); ?>&MD=<?php print $_REQUEST['MD']; ?>" width="100%" height="500"></iframe>
