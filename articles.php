...
<head>
	...
	<title>Press Releases/Articles</title>
	<!-- InstanceEndEditable -->
            ...
            <div id="Page">
              ...
              <p class="breadCrumb"><a href="index.php">Home</a></p>
				...
				if($data->TotalRows > 0) {
					echo '<ul>';
					while($data->Row) {
						print sprintf('<li><strong><a href="article.php?id=%d" title="%s">%s</a></strong></li>', $data->Row['Article_Category_ID'], $data->Row['Category_Title'], $data->Row['Category_Title']);
						$data->Next();
					}
					echo '</ul>';
				} else {
