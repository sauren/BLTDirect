...
if($secure) {
	$dataCache = new DataQuery(sprintf("SELECT rc.ReportCacheID, rc.CreatedOn FROM report_cache AS rc INNER JOIN report AS r ON r.ReportID=rc.ReportID WHERE r.Reference LIKE 'orderturnovermonthly' ORDER BY rc.CreatedOn DESC LIMIT 0, 1"));
