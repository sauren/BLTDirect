...
<div id="PageWrapper">
	<div id="Page">
		<div id="PageContent"><!-- InstanceBeginEditable name="pageContent" -->
			<h1><?php print sprintf('%s%s Order Payment Details for %s', $order->Prefix, $order->ID, $order->Customer->Contact->Person->GetFullName()); ?></h1>

			<p><a href="order_details.php?orderid=<?php echo $order->ID; ?>">Back to Order Details</a></p>
			<table width="100%"  border="0" cellspacing="0" cellpadding="0" class="invoicePaymentDetails">
			  ...
			  <tr>
			    ...
			    <td><?php echo $order->Card->Type->Name; ?>&nbsp;</td>
		      </tr>
			  <tr>
			    <th>Credit Card </th>
			    <td><?php echo (Setting::GetValue('process_manual_payment') == 'true')?$order->Card->GetNumber():$order->Card->PrivateNumber(); ?>&nbsp;</td>
		      </tr>
			  <tr>
			    <th>Name on Card </th>
