...
if($debit->Supplier->ID != $supplierId) {
	redirect(sprintf("Location: debits_pending.php"));
}
?>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
			    ...
			    <table border="0" cellpadding="0" cellspacing="0" class="invoicePaymentDetails">
			      <tr>
			        <th>Debit:</th>
			        <td><?php echo $debit->Prefix.$debit->ID; ?></td>
			      </tr>
			      <tr>
			        <th>Supplier:</th>
			        <td>
							...
							if(count($debit->Line) > 0) {
								for($k=0; $k<count($debit->Line); $k++) {
									...
									<tr>
							      		...
							      		<td nowrap="nowrap"><?php echo $debit->Line[$k]->Product->Name; ?></td>
							      		<td nowrap="nowrap"><?php echo $debit->Line[$k]->Description; ?></td>
