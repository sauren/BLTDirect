...
<div id="PageWrapper">
	<div id="Page">
		<div id="PageContent"><!-- InstanceBeginEditable name="pageContent" -->
			...
			$table->SetSQL(sprintf("SELECT o.*, pg.Postage_Title, COUNT(ob.OrderBiddingID) AS Bids FROM orders AS o LEFT JOIN postage AS pg ON o.Postage_ID=pg.Postage_ID LEFT JOIN order_bidding AS ob ON ob.OrderID=o.Order_ID AND ob.SupplierID=%d AND ob.IsAccepted='N' WHERE o.Status LIKE 'Pending' AND o.Is_Bidding='Y' GROUP BY o.Order_ID", $supplierId));
			...
			$table->AddLink("order_bidding_details.php?orderid=%s", "<img src=\"images/folderopen.gif\" alt=\"Open Order Details\" border=\"0\" />", "Order_ID");
			$table->SetMaxRows(25);
