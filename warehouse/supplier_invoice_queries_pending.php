...
<div id="PageWrapper">
	<div id="Page">
		<div id="PageContent"><!-- InstanceBeginEditable name="pageContent" -->
			<h1>Pending Invoice Queries</h1>
			<br />

			<?php
            $table = new DataTable('queries');
			$table->SetSQL(sprintf("SELECT siq.* FROM supplier_invoice_query AS siq WHERE siq.Status LIKE 'Pending' AND siq.SupplierID=%d", $supplierId));
