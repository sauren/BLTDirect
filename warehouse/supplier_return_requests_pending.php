...
<div id="PageWrapper">
	<div id="Page">
		<div id="PageContent"><!-- InstanceBeginEditable name="pageContent" -->
			...
			$table->SetSQL(sprintf("SELECT srr.* FROM supplier_return_request AS srr WHERE srr.Status LIKE 'Pending' AND srr.SupplierID=%d AND srr.PurchaseID=0", $supplierId));
