...
<div id="PageWrapper">
	<div id="Page">
		<div id="PageContent"><!-- InstanceBeginEditable name="pageContent" -->
			<h1>Confirmed Purchase Requests</h1>
			<br />

			<?php
			$table = new DataTable("requests");
			$table->SetSQL(sprintf("SELECT pr.* FROM purchase_request AS pr WHERE pr.Status LIKE 'Confirmed' AND pr.SupplierID=%d", $supplierId));
