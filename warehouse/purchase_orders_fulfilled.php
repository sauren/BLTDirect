...
<div id="PageWrapper">
	<div id="Page">
		<div id="PageContent"><!-- InstanceBeginEditable name="pageContent" -->
			<h1>Fulfilled Purchase Orders</h1>
			<br />

			<?php
			$table = new DataTable("orders");
			$table->SetSQL(sprintf("SELECT p.* FROM purchase AS p WHERE p.Supplier_ID=%d AND p.For_Branch>0 AND p.Purchase_Status LIKE 'Fulfilled'", $supplierId));
