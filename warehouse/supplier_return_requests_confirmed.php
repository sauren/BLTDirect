...
<div id="PageWrapper">
	<div id="Page">
		<div id="PageContent"><!-- InstanceBeginEditable name="pageContent" -->
			<h1>Confirmed Return Requests</h1>
			<br />

			<?php
			$table = new DataTable("requests");
			$table->SetSQL(sprintf("SELECT srr.* FROM supplier_return_request AS srr WHERE srr.Status LIKE 'Confirmed' AND srr.SupplierID=%d", $supplierId));
